...
export const layoutConfigs = {
  ...
  editorial: {
    id: 'editorial',
    name: '编辑布局',
    description: '红白干净，引言卡片，经典编辑风',
  },
  graphite: {
    id: 'graphite',
    name: '石墨布局',
    description: '石墨灰+极细线，超大留白，理性极简',
  },
  ticket: {
    id: 'ticket',
    name: '票据布局',
    description: '门票/票据视觉隐喻，硬阴影描边',
  },
  journal: {
    id: 'journal',
    name: '内刊布局',
    description: '内刊/手记质感，米白纸感底，分节多样',
  },
}
...
export const builtInThemes: Record<string, ThemeConfig> = {
  ...
  moyuGreen: {
    ...
    name: '摸鱼绿',
    type: 'built-in',
    description: '绿色杂志风，卡片丰富、信息密度高。适合教程、测评、清单',
    layout: 'magazine',
    colors: {
      primary: '#059669',
      secondary: '#10B981',
    ...
    fonts: {
      title: '-apple-system, BlinkMacSystemFont, "PingFang SC", "Hiragino Sans GB", "Microsoft YaHei", sans-serif',
  ...
  redWhite: {
    ...
    name: '红白色系',
    type: 'built-in',
    description: '经典编辑风，红色克制点睛。适合深度分析、观点类文章',
    layout: 'editorial',
    colors: {
      primary: '#DC2626',
      secondary: '#EF4444',
  ...
  graphiteMinimal: {
    ...
    name: '石墨极简',
    type: 'built-in',
    description: '极简克制、留白理性。适合设计、科技评论、专业观点',
    layout: 'graphite',
    colors: {
      primary: '#52525B',
      secondary: '#71717A',
  ...
  zenWhitespace: {
    ...
    name: '留白禅意',
    type: 'built-in',
    description: '禅意冥想、极简生活、深度随笔。呼吸感最强的主题',
    layout: 'zen',
    colors: {
      primary: '#4A5D52',
      secondary: '#6B8C7A',
  ...
  moyuTicket: {
    ...
    name: '摸鱼票据',
    type: 'built-in',
    description: '票据/门票视觉隐喻。适合测评、工具对比、创意评测',
    layout: 'ticket',
    colors: {
      primary: '#059669',
      secondary: '#F59E0B',
  ...
  oliveJournal: {
    ...
    name: '橄榄手记',
    type: 'built-in',
    description: '编辑部内刊质感。适合内刊手记、深度评测、案例复盘',
    layout: 'journal',
    colors: {
      primary: '#1e1f23',
      secondary: '#ed7b2f',
